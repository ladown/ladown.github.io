...
window.addEventListener("DOMContentLoaded", function () {
  ...
  menuOpen(); // Lines with skill

  var counters = document.querySelectorAll(".skills__ratings-counter");
  var lines = document.querySelectorAll(".skills__ratings-line span");
  counters.forEach(function (item, i) {
    lines[i].style.width = item.innerHTML;
  }); // Menu press and close

  var menuItem = document.querySelectorAll(".menu__link a");
  ...
  var iconUp = document.querySelector(".link");
  var asidePanel = document.querySelector(".sidepanel");
  ...
  var formBtn = document.querySelector(".contacts__btn");
  var contactsModal = document.querySelector(".modal__area-contacts");
  var contactsModalClose = document.querySelector(".modal__img-contacts");
